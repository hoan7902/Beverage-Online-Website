  ...
  return (
    ...
    >
        ...
        >
            ...
            <Typography margin='20px 0' fontWeight={600} fontSize='20px'>More cool features available on the app</Typography>
            <Typography>Download Grab app to use other payment methods <br/> and enjoy seamless communication with your driver</Typography>
            <Stack 
                flexDirection='row'

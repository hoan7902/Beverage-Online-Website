...
function Step4(){
    return (
        ...
        <div style={{display:"flex",borderBottom:"2px soild #D8B979"}}>
            ...
            <div style={{display:"flex",alignContent:"center",margin:"10px 50px 0 50px"}}>
            ...
            <InfoCustomer>
                <div style={{margin:"0 20px"}}>
                    <p style={{fontSize:"20px",fontWeight:500,color:"#333"}}>Họ tên khách hàng</p>
                    <p style={{fontSize:"20px",color:"#2F2F2F"}}>Vince</p>
                </div>
                <div style={{margin:"0 20px"}}>
                    <p style={{fontSize:"20px",fontWeight:500,color:"#333"}}>Điện thoại liên lạc</p>
                    <p style={{fontSize:"20px",color:"#2F2F2F"}}>097 181 0800</p>
                </div>
                <div style={{margin:"0 20px"}}>
                    <p style={{fontSize:"20px",fontWeight:500,color:"#333"}}>Địa chỉ giao hàng</p>
                    <p style={{fontSize:"20px",color:"#2F2F2F"}}>22/4G, Mỹ Hòa 1, Trung Chánh, Hóc Môn, TP.HCM</p>
                </div>
            </InfoCustomer>
            <div style={{display:"flex",alignContent:"center",margin:"10px 50px 0 50px"}}>
                <TitleStep>Thông tin đơn hàng</TitleStep>
                <ButtonChange><Link href="/createorder/step2">Thay đổi</Link></ButtonChange>
            </div>
            <Cost>
                <div style={{borderBottom:"1px solid #BAB8B8"}}>
                    <div style={{display:"flex",margin:"10px 40px 10px 40px"}}>
                        <p style={{flex:"1",fontSize:"22px",color:"#6B6B6B"}}>Chi phí món ăn</p>
                        <p style={{flex:"0.2",fontSize:"22px",color:"#6B6B6B"}}>69.000đ</p>
                    </div>
                    <div style={{display:"flex",margin:"10px 40px 10px 40px"}}>
                        <p style={{flex:"1",fontSize:"22px",color:"#6B6B6B"}}>Phí vận chuyển</p>
                        <p style={{flex:"0.2",fontSize:"22px",color:"#6B6B6B"}}>9.000đ</p>
                    </div>
                </div>
                <div style={{display:"flex",margin:"20px 40px"}}>
                    <p style={{flex:"1",fontSize:"30px",fontWeight:500}}>Tổng chi phí</p>
                    <p style={{flex:"0.2",fontSize:"30px",fontWeight:500}}>246.000đ</p>
                </div>
                
            </Cost>
            <div style={{display:"flex",alignContent:"center",margin:"20px 50px 0 50px"}}>
                <TitleStep>Hình thức thanh toán</TitleStep>
                <ButtonChange><Link href="/createorder/step3">Thay đổi</Link></ButtonChange>
            </div>
            <PayMent>
                 <div style={{margin:"10px 40px"}}>
                 <p style={{fontSize:"20px",fontWeight:500,color:"#333"}}>Khách hàng thanh toán</p>
                <p style={{fontSize:"20px",color:"#2F2F2F"}}>COD-Thanh toán khi nhận hàng</p>
                </div>

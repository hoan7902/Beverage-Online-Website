...
function Step2() {
    ...
    <>
          ...
          return (
            <div className={style["cart-item"]} key={index}>
                 <div style={{display:"flex"}} className={style["cart-image"]}>
                  <Image src={cart.product.image} alt={cart.product.name} width={"100px"} height={"100px"}/>
      ...
      <div className={style["cost"]} style={{ height: "100px",display:"flex",flexDirection: "row"}}>
        <p style={{ fontSize: "25px", marginLeft: "50px", fontWeight: 600, flex:"1"}}>
          Tổng chi phí
        </p>
        <p
        style={{

...
export default function Login()
{
     ...
     return (
            ...
            <span className="min-text-gray min-text">Quên mật khẩu?
            <a href="/misspassword" className="forward min-text">Cài đặt lại mật khẩu</a>
            </span>
            <button type="submit" className="Orange_Button">
            <span >Đăng nhập</span>
            </button>
            </form>
            <span className="medium-text">Chưa có tài khoản?
                        <a href='/register' className="forward">Đăng ký</a>
                    </span>
                </div>
